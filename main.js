...
const typenameTv = inventory.map((invent) => {
  return invent.type;
});
...
const soldOutTv = inventory.filter((invent) =>{
  return (invent.originalStock - invent.sold) === 0
});
...
const ambiLightTv = inventory.filter((invent) =>{
